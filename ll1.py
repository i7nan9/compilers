...
def _demo_parse(grammar: Grammar, syms: str):
    ...
    #_demo_parse(grammar, table, syms)
    
    print(str_parse(grammar,table,syms))
...
def main():
    ...
    B' := b F B' |@
    '''
    _demo_parse(bnf_parser.parse(bnf), 'id eq id + id * id'.split())
